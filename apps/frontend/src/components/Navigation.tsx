...
import { IconCards, IconBookmark, IconCertificate, IconCalendar, IconMessageCircle } from '@tabler/icons-react';
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {/* Additional actions can live under Profile if we exceed space */}
      </Box>
    </Box>
  );
};
